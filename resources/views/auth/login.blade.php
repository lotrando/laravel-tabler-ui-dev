  ...
  <div class="page page-center">
    <div class="container-tight container py-4">
      <div class="mb-4 text-center">
        <a class="navbar-brand navbar-brand-autodark" href="."><img src="{{ __('static/logo.svg') }}" alt="" height="36"></a>
      </div>
        ...
        <div class="card-body">
          ...
          <form action="./" method="get" autocomplete="off" novalidate="">
            <div class="mb-3">
              ...
              <input class="form-control" type="email" placeholder="your@email.com" autocomplete="off">
            </div>
            <div class="mb-2">
              ...
              <div class="input-group input-group-flat">
                ...
                <span class="input-group-text">
                  <a class="link-secondary" data-bs-toggle="tooltip" data-bs-original-title="Show password" href="#" aria-label="Show password">
